...
const updateComuna = () => {
    ...
    if (region_comuna.regiones.some(region => region.nombre == selectedRegion)){
        let finded = region_comuna.regiones.find(region => region.nombre == selectedRegion)
        let comunas = finded?.comunas 
